...
router.delete('/:id', auth_middleware_1.authenticate, auth_middleware_1.authorizeAdmin, feedbackController.deleteFeedback);
router.delete('/:id/comment/:commentId', auth_middleware_1.authenticate, auth_middleware_1.authorizeAdmin, feedbackController.deleteFeedbackComment);
